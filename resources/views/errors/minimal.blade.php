    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        body {
            ...
            background: linear-gradient(135deg, #450a0a 0%, #2a0a0a 50%, #1a0505 100%);
            position: fixed;
            top: 0;
            left: 0;
            right: 0;
        ...
        .glass-card {
            ...
            padding: clamp(1.75rem, 3.2vw, 3.5rem) clamp(1.25rem, 3.2vw, 2.75rem);
        ...
        .app-logo { height: clamp(50px, 8vw, 70px); width: auto; margin: 0; filter: drop-shadow(0 4px 12px rgba(239, 68, 68, 0.3)); }
        ...
        .error-icon { width: clamp(48px, 7vw, 70px); height: clamp(48px, 7vw, 70px); color: #ffffff; filter: drop-shadow(0 4px 20px rgba(239, 68, 68, 0.5)); animation: iconFloat 3s ease-in-out infinite; }
        ...
        .error-heading {
            font-size: clamp(1.25rem, 3.8vw, 1.85rem); font-weight: 800; color: #f9fafb; margin: 0.5rem 0 1rem; text-shadow: 0 2px 20px rgba(239, 68, 68, 0.4); position: relative; display: block;
        }
        .error-heading::after { content: ''; position: absolute; bottom: -8px; left: 50%; transform: translateX(-50%); width: 60px; height: 4px; background: linear-gradient(90deg, transparent, #ef4444, transparent); border-radius: 2px; animation: underlineGlow 2s ease-in-out infinite; }
        ...
        .error-description { font-size: clamp(0.9rem, 2.4vw, 1.05rem); color: #9ca3af; margin-bottom: 2rem; line-height: 1.8; max-width: 520px; margin-left: auto; margin-right: auto; }
        ...
        .btn-secondary { color: #f9fafb; background: rgba(31, 41, 55, 0.9); border: 2px solid rgba(239, 68, 68, 0.4); box-shadow: 0 12px 35px rgba(239, 68, 68, 0.25), 0 0 50px rgba(239, 68, 68, 0.15); }
        .btn-secondary:hover { transform: translateY(-4px) scale(1.02); box-shadow: 0 12px 35px rgba(239, 68, 68, 0.25), 0 0 50px rgba(239, 68, 68, 0.15); }
    ...
    <script>
        (function() {
            ...
            const particlePositions = [
                { left: 5, delay: 0, duration: 12 }, { left: 15, delay: 2, duration: 14 }, { left: 25, delay: 4, duration: 13 }, { left: 35, delay: 1, duration: 15 }, { left: 45, delay: 3, duration: 11 }, { left: 55, delay: 5, duration: 13 }, { left: 65, delay: 2, duration: 14 }, { left: 75, delay: 4, duration: 12 }, { left: 85, delay: 1, duration: 15 }, { left: 95, delay: 3, duration: 13 }, { left: 10, delay: 5, duration: 14 }, { left: 20, delay: 0, duration: 12 }, { left: 30, delay: 3, duration: 15 }, { left: 40, delay: 1, duration: 13 }, { left: 50, delay: 4, duration: 14 }, { left: 60, delay: 2, duration: 12 }, { left: 70, delay: 5, duration: 13 }, { left: 80, delay: 0, duration: 15 }, { left: 90, delay: 3, duration: 14 }, { left: 12, delay: 1, duration: 12 }
            ];
    ...
    <div class="maintenance-page-wrapper">
        ...
        <div class="maintenance-container">
            <div class="glass-card">
                <div class="logo-container" style="display: flex; gap: 0; justify-content: center; align-items: center; margin-bottom: 2rem;">
                    <img src="{{ asset('images/logo.png') }}" alt="Red Crescent" class="app-logo">
                    <img src="{{ asset('images/college_logo.png') }}" alt="University College" class="app-logo">
                    <!-- <img src="{{ asset('images/logo.png') }}" alt="Red Crescent" class="app-logo"> -->
                </div>
                ...
                <div class="icon-container">
                    ...
                    <div class="error-icon-bg">
                        <svg class="error-icon" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" viewBox="0 0 24 24">
                            @if (trim($__env->yieldContent('icon_content')))
                                @yield('icon_content')
                            @else
                ...
                <h2 class="error-heading">@yield('title')</h2>
