...
<head>
    ...
    <style>
        * { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        /* Background Layer for Orbs and Particles */
        .bg-layer {
            position: fixed;
            inset: 0;
            z-index: 5;
        ...
        .error-description { font-size: clamp(0.9rem, 2.4vw, 1.05rem); color: #6b7280; margin-bottom: 2rem; line-height: 1.8; max-width: 520px; margin-left: auto; margin-right: auto; }
        body.dark .error-description { color: #9ca3af; }

        .action-buttons { display: flex; gap: 1rem; justify-content: center; flex-wrap: wrap; direction: rtl; }
        ...
        .btn-secondary { color: #374151; background: rgba(255, 255, 255, 0.9); border: 2px solid rgba(239, 68, 68, 0.25); box-shadow: 0 4px 20px rgba(239, 68, 68, 0.15); }
        body.dark .btn-secondary { color: #f9fafb; background: rgba(31, 41, 55, 0.9); border: 2px solid rgba(239, 68, 68, 0.4); }
    ...
    <div class="maintenance-container">
        <div class="glass-card">
            <div class="logo-container">
                <img src="{{ asset('favicon.ico') }}" alt="Logo" class="app-logo">
            </div>
            ...
            <h2 class="error-heading">{{ $maintenanceTitle }}</h2>
            <p class="error-description">{{ $maintenanceMessage }}</p>
