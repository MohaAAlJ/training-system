...
@if ($this->showTerms)
    <div class="terms-section">
        <label class="checkbox-field" style="display: flex; gap: 12px; align-items: flex-start; cursor: pointer;">
            <input type="checkbox" wire:model.change="termsApproval" class="form__checkbox"
            ...
            <div style="flex: 1;">
                ...
                <p style="margin: 8px 0 0; font-size: 0.8rem; color: var(--primary); font-weight: 600; line-height: 1.4;">
                    ⚠️ ملاحظة هامة: أقر بعلمي أنه في حال قبول طلبي وتخلفي عن الحضور لمباشرة التدريب لمدة تزيد عن 7 أيام من
                    تاريخ البدء المحدد، يحق للإدارة إلغاء التدريب وطي قيدي تلقائياً.
                </p>
            </div>
        </label>
    </div>
