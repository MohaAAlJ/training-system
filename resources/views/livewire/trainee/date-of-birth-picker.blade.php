...
{{--
    ========================================
    DATE OF BIRTH PICKER - CURRENT IMPLEMENTATION
    ========================================
    Uses native HTML5 date input with constraints:
    - Max: now() - 20 years (only allows 20+ year olds)
    - Min: 1950-01-01
    - Respects system locale (Arabic)
    
    ========================================
    REMOVED CUSTOM CALENDAR CODE (COMMENTED)
    ========================================
    
    The following code was previously used for a custom calendar picker
    with month/year selectors, calendar grid, and Arabic month names.
    Total removed: 249 lines (242 in HTML + 7 in JS logic)
--}}
