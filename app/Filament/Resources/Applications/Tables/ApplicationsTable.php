        ...
        return $table
            ...
            ->actions([
                ...
                Action::make('confirm_application')
                    ...
                    ->color('success')
                    ->visible(fn(Application $record) => $record->status === ApplicationStatus::INITIAL_APPROVE && (Auth::user()->isMinistry() || Auth::user()->isCollegeSupervisor()))
                    ->requiresConfirmation()
                    ->action(function (Application $record) {
                ...
                Action::make('end_training')
                    ...
                    ->requiresConfirmation()
                    ->action(function (Application $record) {
                        $record->update(['status' => ApplicationStatus::ENDED_TRAINING, 'end_date' => now()]);
