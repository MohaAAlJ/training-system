    ...
    <div class="page-container">
        ...
        <div class="content-area">
            ...
            <div class="field-row">
                ...
                <span class="field-value field-value-long">{{ $application->section->title ?? '' }}</span>
            </div>
            ...
            <div class="notice-box">
                نحيطكم علما بانه لا مانع لدينا نحو استيعاب المتدرب المذكور اعلاه ضمن برنامج التدريب في  {{ $application->section->title ?? '' }}, وذلك ضمن المعايير التالية:
                <ul>
