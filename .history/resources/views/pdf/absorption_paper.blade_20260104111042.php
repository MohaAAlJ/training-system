...
<body>
    <div class="page-container">
        ...
        <div class="content-area">
            ...
            <div class="field-row">
                <span class="field-label">أنا الطالب/ة: يوسف حسن علي</span>
                <span class="field-value field-value-long">{{ $application->trainee->full_name ?? '' }}</span>
                
                <span class="field-label">التخصص: التحاليل الطبية</span>
                <span class="field-value">{{ $application->trainee->major->name ?? '' }}</span>
            </div>

            <div class="field-row">
                <span class="field-label">أرجو التكرم بالموافقة على طلبي بالتدريب في قسم: مختبرات</span>
            ...
            <div class="field-row">
                 <span class="field-label">مدة التدريب: 100</span>
                 <span class="field-value">{{ $application->duration ?? '' }}</span>
                 
                 <span class="field-label">شهر/أشهر تاريخ البدء المقترح: 02-01-2026</span>
