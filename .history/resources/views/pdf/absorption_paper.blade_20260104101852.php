...
<body>
    ...
    <div class="form-section">
        <div class="form-row">
            <span class="inline-field">السيد/ة: <span
                    class="underline">{{ $name ?? '................................' }}</span></span>
            <span class="inline-field" style="margin-right: 50px;">بتاريخ: <span
                    class="underline">{{ $date ?? '....../....../......' }}</span></span>
        </div>
