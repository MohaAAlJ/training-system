...
<body>
    ...
    <div class="admin-section">
        ...
        <div class="form-section">
            ...
            <div class="form-row">
                أرجو التكرم بالموافقة على طلبي بالتدريب في قسم: <span
        ...
        <div style="text-align: right; margin-top: 20px; line-height: 2;">
            نحيطكم علما بانه لا مانع لدينا نحو استيعاب المتدرب المذكور اعلاه ضمن برنامج التدريب المحدد في .................... وذلك ضمن المعايير التالية:
        </div>

        <div style="margin-top: 30px;">
            <div style="float: right;">
                - الإلتزام بتدريب المتدرب تحت إشراف المشرف المكلف من طرفكم
            </div>
        </div>

        <div style="clear: both; margin-top: 15px;">
            <div style="float: right;">
                - الإلتزام بمتابعة دوام المتدرب ومدتها 6 ساعات يوميا
            </div>
        </div>
            ...
            <table style="width: 100%;">
                <tr>
                    <td style="width: 50%; text-align: right;">
                        التوقيع: <span class="underline" style="min-width: 100px;"></span>
                    </td>
    ...
    <!-- Footer -->
    <div class="footer">
        جمعية الهلال الأحمر الفلسطيني =نس<br>
        <br>
        مدينة الأمل - خانيونس
    </div>
</body>
