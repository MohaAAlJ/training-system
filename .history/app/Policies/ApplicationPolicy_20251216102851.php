...
class ApplicationPolicy
{
    ...
    public function update(User $user, Applications $Applications): bool
    {
        ...
        // أ) مدير التدريب العام: يرى أي طلب في النظام
        if ($user->isGeneralTrainingManager()) {
            return true;
        }

        // ب) المدير الطبي: يفحص هل القسم يتبع لإدارته
        return $applicationس->department->administrative_id === $user->administrative?->id;
    }
