...
class WelcomeForm extends Component
{
    ...
    private function loadTrainingTypes(TrainingSettings $settings): void
    {
        ...
        if ($settings->enable_training_type_university) {
            $types[] = ['id' => \App\Models\Application::TRAINING_TYPE_UNIVERSITY, 'name' => \App\Models\Application::TRAINING_TYPES[\App\Models\Application::TRAINING_TYPE_UNIVERSITY]];
        }
        if ($settings->enable_training_type_practice) {
            $types[] = ['id' => \App\Models\Application::TRAINING_TYPE_PRACTICE, 'name' => \App\Models\Application::TRAINING_TYPES[\App\Models\Application::TRAINING_TYPE_PRACTICE]];
        }
