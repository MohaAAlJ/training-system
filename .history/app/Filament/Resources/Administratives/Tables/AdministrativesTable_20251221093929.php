        ...
        return $table
            ->columns([
                ...
                IconColumn::make('is_medical')
                    ...
                    ->boolean()
                    ->sortable(),
                TextColumn::make('medicalHoaUser.name')
            ...
            ->filters([
                SelectFilter::make('hoa')
                    ->label('رئيس الادارة')
                    ->relationship('hoaUser', 'name')
                    ->searchable()
                    ->preload(),
                SelectFilter::make('medical_hoa')
                    ->label('رئيس الادارة الطبية')
                    ->relationship('medicalHoaUser', 'name')
                    ->searchable()
                    ->preload(),
