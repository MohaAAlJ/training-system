...
class AdministrativesResource extends Resource
{
    ...
    protected static ?string $pluralModelLabel = 'الادارات';
    protected static ?string $navigationLabel = 'الادارات';
    protected static ?int $navigationSort = 1;

    public static function getRelations(): array
    {
        return [
            \App\Filament\Resources\Administratives\RelationManagers\SectionsRelationManager::class,
        ];
    }
