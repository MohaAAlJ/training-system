...
class SectionsResource extends Resource
{
    ...
    // Arabic labels
    protected static ?string $modelLabel = 'الشعبة/الفرع';
    protected static ?string $pluralModelLabel = 'الشعب والفروع';
    protected static ?string $navigationLabel = 'الشعب والفروع';
