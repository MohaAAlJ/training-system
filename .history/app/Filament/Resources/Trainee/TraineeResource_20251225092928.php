...
namespace App\Filament\Resources\Trainee;

use App\Models\Application;

use App\Filament\Resources\Trainee\Pages\CreateTrainees;
use App\Filament\Resources\Trainee\Pages\EditTrainees;
use App\Filament\Resources\Trainee\Pages\ListTrainees;
use App\Filament\Resources\Trainee\Pages\ViewTrainees;
use App\Filament\Resources\Trainee\RelationManagers\ApplicationsRelationManager;
use App\Filament\Resources\Trainee\Schemas\TraineeForm;
use App\Filament\Resources\Trainee\Schemas\TraineesInfolist;
use App\Filament\Resources\Trainee\Tables\TraineeTable;
...
class TraineeResource extends Resource
{
    ...
    {
        return TraineeTable::configure($table);
    }
            ...
            return $query->whereHas('Application', function ($q) {
                $q->where('training_type', Application::TRAINING_TYPE_PRACTICE)
                    ->whereIn('status', [
                        ...
                        Application::STATUS_STRATED_TRAINING,
