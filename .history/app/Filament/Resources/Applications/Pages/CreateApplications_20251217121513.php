...
class CreateApplications extends CreateRecord
{
    ...
    protected function mutateFormDataBeforeCreate(array $data): array
    {
        ...
        // Remove trainee-specific fields before inserting application
        unset($data['national_id'], $data['full_name'], $data['phone_number'], 
              $data['dob'], $data['address'], $data['dob_year'], $data['dob_month'], 
              $data['dob_day'], $data['college_id'], $data['institution_id'], $data['major_id']);
