                ...
                Fieldset::make('البيانات الشخصية للمتدرب')
                    ->schema([
                        ...
                        TextInput::make('national_id')
                            ...
                            ->rules([
                                fn($context, $record) => $context === 'create'
                                    ? 'unique:trainees,national_id'
                                    : 'unique:trainees,national_id,' . ($record?->trainee?->id ?? 'NULL')
                            ])
                            ->validationMessages([
                                ...
                                'unique' => 'رقم الهوية موجود بالفعل في النظام.',
                            ])
                            ->required(fn($context) => $context === 'create'),
                        ...
                        Select::make('training_type')
                            ...
                            ->options(function () {
                                ...
                                if ($settings->enable_training_type_university) {
                                    $options[Application::TRAINING_TYPE_UNIVERSITY] = Application::TRAINING_TYPES[Application::TRAINING_TYPE_UNIVERSITY];
                                }
                                if ($settings->enable_training_type_practice) {
                                    $options[Application::TRAINING_TYPE_PRACTICE] = Application::TRAINING_TYPES[Application::TRAINING_TYPE_PRACTICE];
                                }
                                return $options;
                            })
                            ->default(function () {
                                ...
                                if ($settings->enable_training_type_university && ! $settings->enable_training_type_practice) {
                                    return Application::TRAINING_TYPE_UNIVERSITY;
                                }
                                if (! $settings->enable_training_type_university && $settings->enable_training_type_practice) {
