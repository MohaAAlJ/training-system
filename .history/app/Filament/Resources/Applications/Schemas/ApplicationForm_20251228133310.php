                ...
                Fieldset::make('البيانات الشخصية للمتدرب')
                    ->schema([
                        ...
                        Select::make('institution_id')
                            ...
                            ->visible(fn($record, $context, callable $get) => ! Auth::user()->isCollegeSupervisor() && ! ($context === 'edit' && $get('training_type') == Application::TRAINING_TYPE_PRACTICE))
                            ->dehydrated()
                            ->validationMessages([
                        ...
                        Select::make('major_id')
                            ...
                            ->visible(fn($record, $context, callable $get) => ! ($context === 'edit' && $get('training_type') == Application::TRAINING_TYPE_PRACTICE))
                            ->dehydrated()
                            ->searchable()
                            ->validationMessages([
