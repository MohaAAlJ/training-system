...
class ApplicationsResource extends Resource
{
    ...
    public static function getEloquentQuery(): Builder
    {
        ...
        // 4. الإداري (هنا التعديل الجوهري)
        if ($user->isAdministrative()) {

            // أ) إذا كان مدير تدريب عام (غير طبي) -> يرى الكل (مثل الأدمن في العرض)
            if ($user->isGeneralTrainingManager()) {
                return $query;
            }

            // ب) إذا كان مدير طبي -> يرى فقط طلبات الأقسام التابعة لإدارته
