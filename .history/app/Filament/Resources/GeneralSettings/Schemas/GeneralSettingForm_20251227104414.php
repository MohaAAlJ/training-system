            ...
            ->components([
                ...
                Section::make('التحكّم في المؤسسات والكليات (Institutions & Colleges)')
                    ...
                    ->schema([
                        Grid::make(1)
                            ->schema([
                                \Filament\Forms\Components\CheckboxList::make('active_institutions')
                                    ->label('المؤسسات الفعالة')
                                    ->options(\App\Models\Institution::all()->pluck('name', 'id'))
                                    ->searchable()
                                    ->columns(2)
                                    ->dehydrated(false) // Handled manually in page
                                    ->bulkToggleable(),

                                \Filament\Forms\Components\CheckboxList::make('active_colleges')
                                    ->label('الكليات الفعالة')
