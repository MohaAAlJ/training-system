...
class User extends Authenticatable implements FilamentUser
{
    ...
    CROLE_ADMIN => 'مدير النظام',
        CROLE_DEPARTMENT => 'إداري',
        CROLE_SECTION => 'رئيس قسم',
        CROLE_MOH => 'وزارة الصحة',
        CROLE_COLLEGE => 'مشرف كلية',
        CROLE_HOA => 'رئيس الإدارة',
        CROLE_HOM => 'رئيس الطب',
        CROLE_GTM => 'مدير التدريب العام',
