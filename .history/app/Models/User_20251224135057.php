...
class User extends Authenticatable implements FilamentUser
{
    ...
    puconst STATUS_NEW = 1;
    const STATUS_INITIAL_APPROVE = 2;
    const STATUS_CONFIRMATION = 3;
    const STATUS_WAITING_LIST = 4;
    const STATUS_STRATED_TRAINING = 5;
    const STATUS_ENDED_TRAINING = 6;
    const STATUS_REJECTED = 7;
    const STATUS_DROPPED = 8;
