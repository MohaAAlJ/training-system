...
class User extends Authenticatable implements FilamentUser
{
    ...
    ConstaROLE_ADMIN => 'مدير النظام',
        ConstaROLE_DEPARTMENT => 'إداري',
        ConstaROLE_SECTION => 'رئيس قسم',
        ConstaROLE_MOH => 'وزارة الصحة',
        ConstaROLE_COLLEGE => 'مشرف كلية',
        ConstaROLE_HOA => 'رئيس الإدارة',
        ConstaROLE_HOM => 'رئيس الطب',
        ConstaROLE_GTM => 'مدير التدريب العام',
