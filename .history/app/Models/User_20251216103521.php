...
class User extends Authenticatable implements FilamentUser
{
    ...
    public function getRoleLabelAttribute(): string
    {
        return match ($this->role) {
            Constans::ROLE_ADMIN => 'مسؤول النظام',
            Constans::ROLE_ADMINISTRATIVE => 'إداري',
            Constans::ROLE_DEPARTMENT => 'رئيس قسم',
            Constans::ROLE_COLLEGE => 'مشرف كلية',
            Constans::ROLE_MOH => 'وزارة الصحة',
            default => 'غير محدد',
        };
    }
