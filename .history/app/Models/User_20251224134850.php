...
class User extends Authenticatable implements FilamentUser
{
    ...
    const ROLE_ADMIN = 'مدير النظام';
    const ROLE_DEPARTMENT = 'إداري';
    const ROLE_SECTION = 'رئيس قسم';
    const ROLE_MOH = 'وزا   رة الصحة';
    const ROLE_COLLEGE = 'مشرف   كلية';
    const ROLE_HOA = 'رئيس الإدارة';
    const ROLE_HOM = 'رئيس الطب';
    const ROLE_GTM = 'مدير التدريب العام';
