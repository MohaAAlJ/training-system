...
class User extends Authenticatable implements FilamentUser
{
    ...
    {
        // يجب أن يكون دوره "إداري" + إدارته المرتبطة به نوعها "طبية"
        return $this->isAdministrative() && $this->administrative?->is_medical === true;
    }

    // هل هو مدير تدريب عام (غير طبي)؟
    public function isGeneralTrainingManager(): bool
    {
        // يجب أن يكون دوره "إداري" + إدارته المرتبطة به نوعها "غير طبية" (أو ليس لديه إدارة محددة إذا كان النظام يسمح)
