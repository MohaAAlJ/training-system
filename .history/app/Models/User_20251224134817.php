...
class User extends Authenticatable implements FilamentUser
{
    ...
    CoROLE_ADMIN => 'مدير النظام',
        CoROLE_DEPARTMENT => 'إداري',
        CoROLE_SECTION => 'رئيس قسم',
        CoROLE_MOH => 'وزارة الصحة',
        CoROLE_COLLEGE => 'مشرف كلية',
        CoROLE_HOA => 'رئيس الإدارة',
        CoROLE_HOM => 'رئيس الطب',
        CoROLE_GTM => 'مدير التدريب العام',
