...
class User extends Authenticatable implements FilamentUser
{
    ...
    Constant ROLE_ADMIN => 'مدير النظام',
        Constant ROLE_DEPARTMENT => 'إداري',
        Constant ROLE_SECTION => 'رئيس قسم',
        Constant ROLE_MOH => 'وزارة الصحة',
        Constant ROLE_COLLEGE => 'مشرف كلية',
        Constant ROLE_HOA => 'رئيس الإدارة',
        Constant ROLE_HOM => 'رئيس الطب',
        Constant ROLE_GTM => 'مدير التدريب العام',
