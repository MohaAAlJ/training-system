...
class Constans
{
     ...
     */
    public const STATUS_PENDING = 1;           // قيد الانتظار (تحت المراجعة الأولية)
    public const STATUS_DEPT_APPROVED = 2;     // موافقة الدائرة العامة (مثل الإدارة العامة للصيدلة)
    public const STATUS_ADMIN_APPROVED = 3;    // موافقة إدارة المنشأة (مثل المستشفى)
