...
class Constans
{
    ...
    public const STATUS_CONFIRMATION = 3;    // موافقة إدارة المنشأة (مثل المستشفى)
    public const STATUS_WAITING = 4;            // قيد التدريب (بدأ التدريب فعلياً)
    public const STATUS_START_TRAINING = 5;         // مكتمل (أنهى الساعات المطلوبة)
    public const STATUS_COMPLETED = 6;          // مرفوض
    public const STATUS_DROPPED = 7;           // قائمة الانتظار
    public const STATUS_UNKNOWN = 8;            // موقف مؤقتاً
