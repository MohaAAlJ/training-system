    ...
    public function run(): void
    {
        ...
        $admins = [
            [
                'title' => 'مستشفى الأمل',
                'is_medical' => true,
                'hoa_email' => 'hoa_amal@system.com', 'hoa_name' => 'مدير مستشفى الأمل',
                'hom_email' => 'hom_amal@system.com', 'hom_name' => 'المدير الطبي للأمل',
            ],
            [
                'title' => 'مركز الدير',
                'is_medical' => true, 
                'hoa_email' => 'hoa_deir@system.com', 'hoa_name' => 'مدير مركز الدير',
                'hom_email' => 'hom_deir@system.com', 'hom_name' => 'المدير الطبي للدير',
            ],
            [
                'title' => 'مدينة الأمل',
                'is_medical' => false,
                'hoa_email' => 'hoa_city@system.com', 'hoa_name' => 'مدير مدينة الأمل',
                'hom_email' => null, 'hom_name' => null,
            ],
        ];
